...
describe 'Buildpack packager output' do
  ...
  context 'building the cached buildpack' do
    ...
    it 'outputs the dependencies downloaded, their versions, and download source url' do
      ...
      expect(subject).to include("go version 1.6.1 matches the manifest provided md5 checksum of e277d18dac8a0b9945d4c53adf6e52ee")
      ...
      expect(subject).to include("go version 1.6.2 matches the manifest provided md5 checksum of ebfb8b38330c8779b121c43433c4b9be")
